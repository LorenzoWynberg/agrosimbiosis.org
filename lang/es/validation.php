...
return [
    ...
    */
    ...
    'custom' => [
        //Email
        'email' => [
            'unique' => 'Correo ya existe, por favor escoger otro o intente <a href="' . route(Lang::get('routes.name.login')) . '">iniciar sesion</a>',
            'exists' => 'Correo no existe, ¿Desea <a href="' . route(Lang::get('routes.name.register')) . '">registrarse?</a>',
        ],
        //Invalid Credentials
        'credentials' => 'Credeciales invalidas, por favor revisar correo y contraseña',
    ],
